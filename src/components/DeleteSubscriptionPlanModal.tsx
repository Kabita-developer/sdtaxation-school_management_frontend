...
import { X, AlertTriangle, Trash2, Loader2, Package } from 'lucide-react';
import { SubscriptionPlan } from '../services/mockService';
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 ease-out">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">
                  You are about to permanently delete this subscription plan. This action cannot be undone and may affect companies using this plan.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 space-y-4">
            <h4 className="text-sm font-semibold text-gray-900 mb-3">Plan to be deleted:</h4>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-500">
                  {plan.currency || 'INR'} {plan.price.toLocaleString()} / {plan.duration} months
                </div>
              </div>
            </div>
