...
import { apiService, type DashboardData } from '../services/mockService';
...
import {
  ...
  ArrowUpRight, ArrowDownRight, Minus, Settings, BarChart as BarChartIcon
} from 'lucide-react';
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-200 text-xs mt-1">Collected: ₹{dashboardData.summary.activeRevenue.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100 text-sm">Outstanding Fees</p>
                <p className="text-2xl font-bold">₹{dashboardData.summary.totalBalance.toLocaleString()}</p>
                <p className="text-green-200 text-xs mt-1">Pending Collection</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-orange-200 text-xs mt-1">Active sections</p>
              </div>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={revenueChartData}>
                ...
                <Tooltip
                  ...
                  formatter={(value: any) => [`₹${value.toLocaleString()}`, 'Fees Collected']}
                />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Staff & Teachers</h3>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
        ...
        {dashboardData.companyBalances && dashboardData.companyBalances.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-100">
              <h3 className="text-lg font-semibold text-gray-900">Class-wise Overview</h3>
            </div>
              ...
              {dashboardData.recentTransactions.map((transaction, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <div className="flex items-center space-x-4">
                    <div className={`p-2 rounded-lg ${transaction.type === 'Receipt' ? 'bg-green-100' : 'bg-red-100'
                      }`}>
                  ...
                  <div className="text-right">
                    <p className={`text-sm font-semibold ${transaction.type === 'Receipt' ? 'text-green-600' : 'text-red-600'
                      }`}>
        ...
        {dashboardData.plans && dashboardData.plans.list.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Available Courses/Streams</h3>
