...
export default function GST() {
  const gstShortcuts = [
    { label: 'File Return', icon: Upload, onClick: () => console.log('File Return clicked'), variant: 'primary' as const },
    { label: 'Download Report', icon: Download, onClick: () => console.log('Download clicked'), variant: 'white' as const },
    { label: 'ITC Calc', icon: Calculator, onClick: () => console.log('Calc clicked'), variant: 'white' as const },
  ];

  return (
    <Layout title="GST Management" shortcuts={gstShortcuts}>
